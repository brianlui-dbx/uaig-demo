# Vendored verbatim from databricks/app-templates `agent-langgraph` (agent_server/utils.py).
# Stream/session helpers used by agent.py. Unmodified except this header.
import logging
